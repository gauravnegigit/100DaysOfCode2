    ...
    for x , player1 in enumerate(sort_players):
        for player2 in sort_players[x + 1 : ] :
            ...
            if dis < players[player2]["score"] - players[player1]["score"] * 0.85 :
                players[player2]["score"] = math.sqrt(players[player2]["score"]**2 + players[player1]["score"])
...
def get_start_location(players):
    ...
    while True :
        stop = True 
        x = random.randrange(START_RADIUS , WIDTH)
        y = random.randrange(START_RADIUS , HEIGHT)
