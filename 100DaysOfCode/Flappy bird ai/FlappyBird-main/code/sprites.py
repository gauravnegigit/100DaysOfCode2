...
class Ground(pygame.sprite.Sprite):
	def __init__(self,groups,scale_factor):
		...
		self.image = pygame.transform.scale(ground_surf,pygame.math.Vector2(int(ground_surf.get_width()) , int(ground_surf.get_height())) * int(scale_factor))
...
class Plane(pygame.sprite.Sprite):
	...
	def import_frames(self,scale_factor):
		...
		for i in range(3):
			...
			scaled_surface = pygame.transform.scale(surf,pygame.math.Vector2(int(surf.get_width()) , int(surf.get_height()))* int(scale_factor))
...
class Obstacle(pygame.sprite.Sprite):
	def __init__(self,groups,scale_factor):
		...
		self.image = pygame.transform.scale(surf,pygame.math.Vector2(int(surf.get_width()) , int(surf.get_height())) * int(scale_factor))
