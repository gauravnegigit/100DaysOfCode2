...
class Level :
    def __init__(self , current_level , surface , create_overworld , update_coins , update_health) -> None:
        # general setup
        ...
        self.update_coins , self.update_health = update_coins , update_health
    ...
    def create_landing_dust(self):
        if not self.player_on_ground and self.player.sprite.on_ground and not self.dust_sprite.sprites():
            ...
            # offset's on the basis of the direction of the player 
    ...
    def check_status(self):
        ...
        if self.player.sprite.rect.top > HEIGHT :
            # if the player has fallen create  
            self.create_overworld(self.current_level , 0)
        ...
        # checking for the collision with the enemy

        for enemy in pygame.sprite.spritecollide(self.player.sprite , self.enemy_sprites , False):
            enemy_center = enemy.rect.centery 
            enemy_top = enemy.rect.top
            player_bottom = self.player.sprite.rect.bottom
            if enemy_top < player_bottom < enemy_center and self.player.sprite.direction.y >= 0 :
                self.player.sprite.direction.y = -18 
                self.explosion_sprites.add(Particle(enemy.rect.center,'explosion'))
                enemy.kill()
            else :
                self.player.sprite.lose_health(self.update_health)


    def check_coin_collisons(self):
        for coin in pygame.sprite.spritecollide(self.player.sprite,self.coin_sprites,True):
    ...
    def run(self):
        ...
        # collisions for health and coins 
        self.check_status()
